  ...
  ...svelte.configs["flat/recommended"],
  {
    ...
    rules: {
          ...
          paths: [
            {
              ...
              message:
                "Use callback props instead of component event dispatchers.",
            },
            {
              name: "svelte/legacy",
              message:
                "Use native Svelte 5 APIs instead of compatibility helpers.",
            },
          ],
        },
      ],
      ...
      "perfectionist/sort-imports": [
        "error",
        { newlinesBetween: 1, type: "alphabetical" },
      ],
