...
import {
    capacityForRender, LIVE_MAX_VOICES, OFFLINE_CAPACITY_MULTIPLIER, OFFLINE_NODE_BUDGET_MAX
} from './voice-capacity';
...
describe('voice capacity', () => {
    it('gives offline rendering the same governor with tenfold headroom', () => {
        ...
        expect(capacityForRender(480, true)).toEqual({nodes: 480 * OFFLINE_CAPACITY_MULTIPLIER,
