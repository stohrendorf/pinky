 ...
 * to render. */
export async function renderSongToWav(options: WavExportOptions = {}): Promise<Blob | null> {
...
export async function exportWav(options: WavExportOptions = {}): Promise<string> {
    try {
