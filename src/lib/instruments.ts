...
const fn = (
  ...
  name,
  max,
  partial: (h) => ({ ratio: r3(ratio(h)), level: l2(weight(h)) }),
});
const tbl = (
  name: string,
  ratios: number[],
...
export function createInstrument(
  name: string,
  preset: Partial<InstrumentParams> = {},
): Instrument {
